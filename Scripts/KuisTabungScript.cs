...
public class KuisTabungScript : MonoBehaviour
{
    ...
    public System.Random rndJariJari = new System.Random();
    void Start()
    {
        nilaiUser = new int[5];
    ...
    void createRandomSoalTabung()
    {
        ...
        string soal1 = "Hitunglah volume tabung yang memiliki panjang jari-jari alas sebesar " + rand1Soal1 + " cm dan tinggi " + rand2Soal1 + " cm" + "! (π = 22/7)";
        double jawabanSoal1DB = calculateJawabanVolumeTabung(1, rand1Soal1, rand2Soal1);
        ...
        string soal2 = "Berapa luas permukaan sebuah tabung yang memiliki panjang jari-jari alas sebesar " + rand1Soal2 + " cm dan tinggi " + rand2Soal2 + " cm" + "? (π = 22/7)";
        double jawabanSoal2DB = calculateJawabanLuasPermukaanTabung(rand1Soal2, rand2Soal2);

        int rand1Soal3 = rnd.Next(7, 28);
        int rand2Soal3= rnd.Next(5, 15);

        string soal3 = "Hitunglah volume tabung yang memiliki panjang jari-jari alas sebesar " + rand1Soal3+ " cm dan tinggi " + rand2Soal3+ " cm" + "! (π = 3.14)"; ;
        double jawabanSoal3DB = calculateJawabanVolumeTabung(2, rand1Soal3, rand2Soal3);

        int rand1Soal4 = 7;
        int rand2Soal4 = rnd.Next(1000, 3234);

        string soal4 = "Berapa tinggi tabung yang memiliki volume sebesar " + rand2Soal4 + " dan jari-jari alas sebesar 7cm? (π = 22/7)";
        double jawabanSoal4DB = calculateJawabanTinggi(rand2Soal4);

        string soal5 = "Berapa jumlah titik sudut yang dimiliki bangun ruang tabung?";
        double jawabanSoal5DB = 0;
        ...
        soalKuis[3] = soal4;
        soalKuis[4] = soal5;
        createRandomJawabanTabung(jawabanSoal1DB, jawabanSoal2DB, jawabanSoal3DB, jawabanSoal4DB, jawabanSoal5DB);
    }
    ...
    *
    */
    double calculateJawabanVolumeTabung(int pi, int r, int t) {
    ...
    *
    */
    double calculateJawabanLuasPermukaanTabung(int r, int t)
    {
        double result = 2.0 * 22 * (r / 7) * (r + t);
        return result;
    }
    ...
    */
     ...
     */
    void createRandomJawabanTabung(double jawabanSoal1DB, double jawabanSoal2DB, double jawabanSoal3DB, double jawabanSoal4DB, double jawabanSoal5DB) {
