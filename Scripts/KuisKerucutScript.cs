...
public class KuisKerucutScript : MonoBehaviour
{
    ...
    {
        int result = 7;
        int angka = rndJariJari.Next(1, 5);
        switch (angka)
        {
            case 1:
                result = 7;
    ...
    void createRandomSoalKerucut()
    {
        soalKuis = new string[5];
        System.Random rnd = new System.Random();

        int rand1Soal1 = generateJariJari();
        int rand2Soal1 = rnd.Next(5, 15);

        string soal1 = "Hitunglah volume kerucut yang memiliki panjang jari-jari alas sebesar " + rand1Soal1 + " cm dan tinggi sebesar " + rand2Soal1 + " cm" + "! (π = 22/7)";
        double jawabanSoal1DB = calculateJawabanVolumeKerucut(1, rand1Soal1, rand2Soal1);

        int rand1Soal2 = generateJariJari();
        rand1Soal2 = generateJariJari();
        int rand2Soal2 = rnd.Next(5, 15);

        string soal2 = "Berapa luas permukaan sebuah kerucut yang memiliki panjang jari-jari alas sebesar " + rand1Soal2 + " cm dan garis pelukis sebesar " + rand2Soal2 + " cm" + "? (π = 22/7)";
        double jawabanSoal2DB = calculateJawabanLuasPermukaanKerucut(rand1Soal2, rand2Soal2);

        int rand1Soal3 = rnd.Next(7, 28);
        int rand2Soal3 = rnd.Next(5, 15);

        string soal3 = "Hitunglah volume kerucut yang memiliki panjang jari-jari alas sebesar " + rand1Soal3 + " cm dan tinggi " + rand2Soal3 + " cm" + "! (π = 3.14)"; ;
        double jawabanSoal3DB = calculateJawabanVolumeKerucut(2, rand1Soal3, rand2Soal3);

        int rand2Soal4 = rnd.Next(1000, 3234);

        string soal4 = "Berapa tinggi kerucut yang memiliki volume sebesar " + rand2Soal4 + " dan jari-jari alas sebesar 7cm? (π = 22/7)";
        double jawabanSoal4DB = calculateJawabanTinggi(rand2Soal4);

        int rand1Soal5 = generateJariJari();
        int rand2Soal5 = rnd.Next(5, 15);
        int rand3Soal5 = rand2Soal5 + 3;
        string soal5 = "Hitunglah hasil penjumlahan volume dan luas permukaan kerucut yang memiliki panjang jari-jari alas sebesar " + rand1Soal5 + " cm, tinggi sebesar " + rand2Soal1 + " cm, dan garis pelukis sebesar " + rand3Soal5 + " cm" + "!(π = 22 / 7)";
        double jawabanSoal5DB = calculateVolumePlusLP(rand1Soal5, rand2Soal5, rand3Soal5);
    ...
    double calculateVolumePlusLP(int r, int t, int s) {
        double result = calculateJawabanVolumeKerucut(1, r, t) + calculateJawabanLuasPermukaanKerucut(r, s);
        return result;
    }
    ...
    *
    */
    double calculateJawabanVolumeKerucut(int pi, int r, int t)
    {

        if (pi == 1)
        {
            double result = 0;
            result = 22.0 * (r / 7) * r * t / 3;
            return result;
        }
        else
        {
            double result2 = 3.14 * r * r * t / 3;
            return result2;
        }
    }
    ...
    *
    */
    double calculateJawabanLuasPermukaanKerucut(int r, int s)
    {
        //pi*r*(s+r)
        double result = 22 * (r / 7) * (r + s);
        return result;
    }
    ...
    *
    */
    double calculateJawabanTinggi(int volume)
    {
        double result = volume / (154.0 / 3.0);
        return result;
    }
