...
public class KuisBalokScript : MonoBehaviour
{
    ...
    void createRandomSoalBalok()
    {
        soalKuis = new string[5];
        System.Random rnd = new System.Random();

        int rand1Soal1 = rnd.Next(11, 30);
        int rand2Soal1 =  rand1Soal1 - rnd.Next(5, 8);
        int rand3Soal1 = rand1Soal1 - rnd.Next(1, 4);

        string soal1 = "Hitunglah volume balok yang memiliki panjang sebesar " + rand1Soal1 + " cm, lebar " + rand2Soal1 + " cm, tinggi "+ rand3Soal1 + " cm" + " !";
        double jawabanSoal1DB = calculateJawabanVolumeBalok(rand1Soal1, rand2Soal1, rand3Soal1);

        int rand1Soal2 = rnd.Next(11, 30);
        int rand2Soal2 = rand1Soal2 - rnd.Next(5, 8);
        int rand3Soal2 = rand1Soal2 - rnd.Next(1, 4);

        string soal2 = "Berapa luas permukaan sebuah balok yang memiliki panjang sebesar " + rand1Soal2 + " cm, lebar " + rand2Soal2 + " cm, tinggi " + rand3Soal2 + " cm" + " !";
        double jawabanSoal2DB = calculateJawabanLuasPermukaanBalok(rand1Soal2, rand2Soal2, rand3Soal2);

        int rand1Soal3 = rnd.Next(1000, 1500);
        int rand2Soal3 = rnd.Next(5, 12);
        int rand3Soal3 = rand2Soal3 - rnd.Next(1, 4);

        string soal3 = "Berapa nilai tinggi sebuah kubus yang memiliki volume sebesar " + rand1Soal3 + ", panjang sebesar " + rand2Soal3 + "cm, lebar sebesar " + rand3Soal3 + "cm ?";
        double jawabanSoal3DB = calculateJawabanTinggi(rand1Soal3, rand2Soal3, rand3Soal3);

        int rand1Soal4 = rnd.Next(11, 30);
        int rand2Soal4 = rand1Soal4 - rnd.Next(5, 8);
        int rand3Soal4 = rand1Soal4 - rnd.Next(1, 4);

        string soal4 = "Hitunglah hasil penjumlahan dari volume dan luas permukaan sebuah kubus yang memiliki panjang sebesar " + rand1Soal4 + " cm, lebar " + rand2Soal4 + " cm, tinggi " + rand3Soal4 + " cm" + " !";
        double jawabanSoal4DB = calculateJawabanVolumePlusLP(rand1Soal4, rand2Soal4, rand3Soal4);

        string soal5 = "Berapa jumlah sisi yang dimiliki bangun ruang balok?";
        double jawabanSoal5DB = 6;
        ...
        soalKuis[3] = soal4;
        soalKuis[4] = soal5;
        createRandomJawabanBalok(rand1Soal1, rand1Soal2, rand1Soal4, jawabanSoal1DB, jawabanSoal2DB, jawabanSoal3DB, jawabanSoal4DB, jawabanSoal5DB);
    }
    ...
    *
    */
    double calculateJawabanVolumeBalok(int panjang, int lebar, int tinggi) {
    ...
    *
    */
    double calculateJawabanVolumePlusLP(int panjang, int lebar, int tinggi)
    {
        double result = calculateJawabanVolumeBalok(panjang, lebar, tinggi) + calculateJawabanLuasPermukaanBalok(panjang, lebar, tinggi);
        return result;
    }
    ...
    *
    */
    double calculateJawabanLuasPermukaanBalok(int panjang, int lebar, int tinggi)
    {
        int result = 2 * (panjang * lebar + panjang * tinggi + lebar * tinggi);
        return result;
    }
    ...
    *
    */
    double calculateJawabanTinggi(int volume, int panjang, int lebar)
    {
        double result = volume / panjang / lebar;
        return result;
    }
     ...
     */
    void createRandomJawabanBalok(int rusuk1, int rusuk2, int rusuk3, double jawabanSoal1DB, double jawabanSoal2DB, double jawabanSoal3DB, double jawabanSoal4DB, double jawabanSoal5DB) {
        ...
        jawabanSoal1[2] = (jawabanSoal1DB - rusuk1).ToString("0.##");
        ...
        jawabanSoal2[2] = (jawabanSoal2DB + 6).ToString("0.##");
        ...
        jawabanSoal3[2] = (jawabanSoal3DB + 10).ToString("0.##");
        jawabanSoal3[3] = (jawabanSoal3DB + 1).ToString("0.##");
